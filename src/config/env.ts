...
export function loadEnvConfig(): EnvConfig {
  ...
  config.PAYCHANGU_ENVIRONMENT = (process.env.PAYCHANGU_ENVIRONMENT as Environment) || DEFAULT_CONFIG.PAYCHANGU_ENVIRONMENT;

  // PawaPay Configuration
  config.PAWAPAY_JWT = process.env.PAWAPAY_JWT || '';
  config.PAWAPAY_ENVIRONMENT = (process.env.PAWAPAY_ENVIRONMENT as Environment) || DEFAULT_CONFIG.PAWAPAY_ENVIRONMENT;
 ...
 */
export function validatePSPConfig(config: EnvConfig, psp: 'paychangu' | 'pawapay'): PSPValidationResult {
