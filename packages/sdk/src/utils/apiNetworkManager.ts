...
export class ApiNetworkManager {
   ...
   */
  async get<T>(endpoint: string, config: AxiosRequestConfig = {}, context = "GET request"): Promise<T> {
    try {
   ...
   * @returns Promise resolving to the response data
   */
  async post<T>(endpoint: string, data: unknown, config: AxiosRequestConfig = {}, context = "POST request"): Promise<T> {
    try {
   ...
   * @returns Promise resolving to the response data
   */
  async put<T>(endpoint: string, data: unknown, config: AxiosRequestConfig = {}, context = "PUT request"): Promise<T> {
    try {
   ...
   * @returns Promise resolving to the response data
   */
  async delete<T>(endpoint: string, config: AxiosRequestConfig = {}, context = "DELETE request"): Promise<T> {
    try {
